...
# Generated by qmake (2.01a) (Qt 4.6.0) on: ?? 3? 25 14:33:23 2010
# Project:  qjdspsshow.pro
# Template: app
# Command: /home/xtf/qtsdk-2009.05/qt/bin/qmake -spec ../../qtsdk-2009.05/qt/mkspecs/linux-g++-64 -unix CONFIG+=debug -o Makefile qjdspsshow.pro
#############################################################################
...
INCPATH       = -I../../qtsdk-2009.05/qt/mkspecs/linux-g++-64 -I. -I../../qtsdk-2009.05/qt/include/QtCore -I../../qtsdk-2009.05/qt/include/QtGui -I../../qtsdk-2009.05/qt/include -I. -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-rpath,/home/xtf/qtsdk-2009.05/qt/lib
LIBS          = $(SUBLIBS)  -L/home/xtf/qtsdk-2009.05/qt/lib -lQtGui -L/home/xtf/qtsdk-2009.05/qt/lib -L/usr/X11R6/lib64 -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /home/xtf/qtsdk-2009.05/qt/bin/qmake
TAR           = tar -cf
COMPRESS      = gzip -9f
COPY          = cp -f
SED           = sed
...
Makefile: qjdspsshow.pro  ../../qtsdk-2009.05/qt/mkspecs/linux-g++-64/qmake.conf ../../qtsdk-2009.05/qt/mkspecs/common/g++.conf \
		../../qtsdk-2009.05/qt/mkspecs/common/unix.conf \
		../../qtsdk-2009.05/qt/mkspecs/common/linux.conf \
		../../qtsdk-2009.05/qt/mkspecs/qconfig.pri \
		../../qtsdk-2009.05/qt/mkspecs/features/qt_functions.prf \
		...
		../../qtsdk-2009.05/qt/mkspecs/features/lex.prf \
		../../qtsdk-2009.05/qt/mkspecs/features/include_source_dir.prf \
		/home/xtf/qtsdk-2009.05/qt/lib/libQtGui.prl \
		/home/xtf/qtsdk-2009.05/qt/lib/libQtCore.prl
	$(QMAKE) -spec ../../qtsdk-2009.05/qt/mkspecs/linux-g++-64 -unix CONFIG+=debug -o Makefile qjdspsshow.pro
...
moc_qjd_sps_mainwindow.cpp: qjd_sps_widget.h \
	...
	/home/xtf/qtsdk-2009.05/qt/bin/moc $(DEFINES) $(INCPATH) qjd_sps_mainwindow.h -o moc_qjd_sps_mainwindow.cpp

moc_qjd_sps_widget.cpp: qjd_sps_option.h \
		ui_qjd_sps_option.h \
		qjd_sps_widget.h
	/home/xtf/qtsdk-2009.05/qt/bin/moc $(DEFINES) $(INCPATH) qjd_sps_widget.h -o moc_qjd_sps_widget.cpp

moc_qjd_sps_openfile.cpp: ui_qjd_sps_openfile.h \
		qjd_sps_openfile.h
	/home/xtf/qtsdk-2009.05/qt/bin/moc $(DEFINES) $(INCPATH) qjd_sps_openfile.h -o moc_qjd_sps_openfile.cpp

moc_qjd_sps_combinefiles.cpp: ui_qjd_sps_combinefiles.h \
		qjd_sps_combinefiles.h
	/home/xtf/qtsdk-2009.05/qt/bin/moc $(DEFINES) $(INCPATH) qjd_sps_combinefiles.h -o moc_qjd_sps_combinefiles.cpp

moc_qjd_sps_option.cpp: ui_qjd_sps_option.h \
		qjd_sps_option.h
	/home/xtf/qtsdk-2009.05/qt/bin/moc $(DEFINES) $(INCPATH) qjd_sps_option.h -o moc_qjd_sps_option.cpp

moc_qjd_sps_help.cpp: ui_qjd_sps_help.h \
		qjd_sps_help.h
	/home/xtf/qtsdk-2009.05/qt/bin/moc $(DEFINES) $(INCPATH) qjd_sps_help.h -o moc_qjd_sps_help.cpp
...
qrc_image.cpp: image.qrc \
	...
	/home/xtf/qtsdk-2009.05/qt/bin/rcc -name image image.qrc -o qrc_image.cpp
...
ui_qjd_sps_mainwindow.h: qjd_sps_mainwindow.ui
	/home/xtf/qtsdk-2009.05/qt/bin/uic qjd_sps_mainwindow.ui -o ui_qjd_sps_mainwindow.h

ui_qjd_sps_openfile.h: qjd_sps_openfile.ui
	/home/xtf/qtsdk-2009.05/qt/bin/uic qjd_sps_openfile.ui -o ui_qjd_sps_openfile.h

ui_qjd_sps_combinefiles.h: qjd_sps_combinefiles.ui
	/home/xtf/qtsdk-2009.05/qt/bin/uic qjd_sps_combinefiles.ui -o ui_qjd_sps_combinefiles.h

ui_qjd_sps_option.h: qjd_sps_option.ui
	/home/xtf/qtsdk-2009.05/qt/bin/uic qjd_sps_option.ui -o ui_qjd_sps_option.h

ui_qjd_sps_help.h: qjd_sps_help.ui
	/home/xtf/qtsdk-2009.05/qt/bin/uic qjd_sps_help.ui -o ui_qjd_sps_help.h
