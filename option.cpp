...
void Option::on_btnApply_clicked()
{
...
void Option::on_btnClose_clicked()
{
    close();
}

void Option::on_btnShotLineSC_clicked()
{
    QColorDialog a;
...
void Option::on_btnReceiverLineSC_clicked()
{
    QColorDialog a;
...
void Option::on_btnMouseClickedSC_clicked()
{
    QColorDialog a;
...
void Option::on_btnMouseRelationSCSL_clicked()
{
    QColorDialog a;
...
void Option::on_btnMouseRelationSCRL_clicked()
{
    QColorDialog a;
...
void Option::on_btnShotLineConSC_clicked()
{
    QColorDialog a;
...
void Option::on_btnReceiveLineConSC_clicked()
{
    QColorDialog a;
...
void Option::on_btnCMPSC_clicked()
{
    QColorDialog a;
...
void Option::on_spinShotLine_valueChanged(QString s)
{
...
void Option::on_spinReceiveLine_valueChanged(QString s)
{
...
void Option::on_spinMouseClicked_valueChanged(QString s)
{
...
void Option::on_spinShotLineRelated_valueChanged(QString s)
{
...
void Option::on_spinReceiveLineRelated_valueChanged(QString s)
{
...
void Option::on_spinShotLineCon_valueChanged(QString s)
{
...
void Option::on_spinReceiveLineCon_valueChanged(QString s)
{
...
void Option::on_spinCMP_valueChanged(QString s)
{
...
void Option::on_comboCMPAccuracy_currentIndexChanged(int index)
{
    //CMP精度
    int acc=index;
